...
export const AGENT_DESCRIPTIONS: Record<number, string> = {
  [AGENT_NUMBERS.BUSINESS_INTELLIGENCE]:
    "Revenue tracking and financial analytics with Stripe integration",
  // Temporarily commented out for single-agent deployment
  // [AGENT_NUMBERS.WEB_SCRAPING]:
  //   "Data extraction and web scraping with Apify integration",
  // [AGENT_NUMBERS.SOCIAL_MEDIA]:
  ...
  // [AGENT_NUMBERS.SYSTEM_ARCHITECTURE]:
  //   "Real-time system visualization and monitoring",
  // [AGENT_NUMBERS.PASSWORD_VAULT]:
  //   "Secure credential storage with biometric authentication",
  // [AGENT_NUMBERS.PERSONAL_DIRECTORY]:
  //   "Bookmarks, shortcuts, and personal organization",
};
