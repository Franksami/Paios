...
export function AgentDisplay({ agentNumber, agentName, agentDescription }: AgentDisplayProps) {
  const { initializeAgent, executeCommand, agents } = useAgentStore()
    ...
    return (
      <div className="flex items-center justify-center py-8">
        <div className="flex flex-col items-center space-y-4">
          ...
          />
          <p className="text-gray-600 dark:text-gray-400">Initializing {agentName}...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    ...
    >
      <div className="border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{agentDescription}</p>
      </div>
